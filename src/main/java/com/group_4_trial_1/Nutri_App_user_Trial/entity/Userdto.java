...
public class Userdto {
    ...
    public Userdto(String name, String contact, String gender, LocalDate dob) {
        this.name = name;
        this.contact = contact;
        this.gender = gender;
        this.dob = dob;
    ...
    public Userdto(String userIdentification, String name, String contact, String gender, LocalDate dob) {
        this.userIdentification = userIdentification;
        this.name = name;
        this.contact = contact;
        this.gender = gender;
